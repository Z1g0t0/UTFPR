...
async def create_payment_intent(request: PaymentIntentRequest):
    ...
    try:
        ...
        #print(f"[MS]Pagamento -> INTENT: {str(payment_intent)}")

        #channel.basic_publish(
        #    exchange = "Pagamentos_Aprovados",
        #    routing_key=f"Pagamento.Valor:{request.amount}.Aprovado",
        #    body = str(payment_intent) )
...
async def stripe_webhook(request: Request):
    ...
    print(f"[MS]PAGAMENTO -> STRIPE WEBHOOK")
