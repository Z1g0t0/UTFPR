...
task_t * scheduler() {
	...
	PRINT_READY_QUEUE      	
    #endif
	//Variaveis para traversar e achar a proxima tarefa
	...
	//"Rejuvenesce a tarefa escolhida
	task_setcounter(readyQueue, -(readyQueue->counter));
        return readyQueue;
    }
    return NULL;
}
